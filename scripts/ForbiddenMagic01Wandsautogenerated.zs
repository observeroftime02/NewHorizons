mods.thaumcraft.Arcane.addShaped("CAP_elementium", <ForbiddenMagic:WandCaps:6>, "aer 60, terra 60, ignis 60, aqua 60, ordo 60, perditio 60", [[<ore:screwTungstenSteel>,<ore:plateInfusedAir>, <ore:screwTungstenSteel>],[<ore:plateInfusedWater>, <ForbiddenMagic:WandCaps:3>;, <ore:plateInfusedFire>],[<ore:screwTungstenSteel>, <ore:plateInfusedEarth>,<ore:screwTungstenSteel>]]);
mods.thaumcraft.Arcane.addShaped("CAP_vinteum", <ForbiddenMagic:WandCaps:1>, "aer 40, terra 40, ignis 40, aqua 40, ordo 40, perditio 40", [[<ore:screwTitanium>,<ore:foilVinteum>, <ore:screwTitanium>],[<ore:foilVinteum>, <ore:ringVinteum>, <ore:foilVinteum>],[<ore:screwTitanium>, <ore:foilVinteum>,<ore:screwTitanium>]]);
mods.thaumcraft.Arcane.addShaped("ROD_witchwood_staff", <ForbiddenMagic:WandCores:10>, "aer 125, terra 125, ignis 125, aqua 125, ordo 125, perditio 125", [[<Thaumcraft:blockCrystal:0>,<Thaumcraft:blockCrystal:1>, <Thaumcraft:ItemResource:15>],[<Thaumcraft:blockCrystal:2>, <ForbiddenMagic:WandCores:4>, <Thaumcraft:blockCrystal:3>],[<ForbiddenMagic:WandCores:4>, <Thaumcraft:blockCrystal:4>,<Thaumcraft:blockCrystal:5>]]);
mods.thaumcraft.Arcane.addShaped("ROD_dreamwood_staff", <ForbiddenMagic:WandCores:13>, "aer 125, terra 125, ignis 125, aqua 125, ordo 125, perditio 125", [[<Thaumcraft:blockCrystal:0>,<Thaumcraft:blockCrystal:1>, <Thaumcraft:ItemResource:15>],[<Thaumcraft:blockCrystal:2>, <ForbiddenMagic:WandCores:11>, <Thaumcraft:blockCrystal:3>],[<ForbiddenMagic:WandCores:11>, <Thaumcraft:blockCrystal:4>,<Thaumcraft:blockCrystal:5>]]);
mods.thaumcraft.Arcane.addShaped("ROD_witchwood_staff", <ForbiddenMagic:WandCaps:10>, "aer 40, terra 40, ignis 40, aqua 40, ordo 40, perditio 40", [[<ore:screwTitanium>,<ore:foilVinteum>, <ore:screwTitanium>],[<ore:foilVinteum>, <ore:ringVinteum>, <ore:foilVinteum>],[<ore:screwTitanium>, <ore:foilVinteum>,<ore:screwTitanium>]]);
...
mods.thaumcraft.Infusion.addRecipe("ROD_livingwood", <Thaumcraft:WandRod:0>,[<AWWayofTime:bucketLife>,<TConstruct:materials:6>,<Thaumcraft:blockMagicalLog:0>,<AWWayofTime:bucketLife>,<TConstruct:materials:6>,<Thaumcraft:blockMagicalLog:0>,<AWWayofTime:bucketLife>,<TConstruct:materials:6>,<Thaumcraft:blockMagicalLog:0>], "victus 64, herba 32, arbor 32, praecantatio 24, instrumentum 24", <ForbiddenMagic:WandCores:7>, 6);
mods.thaumcraft.Infusion.addRecipe("ROD_dreamwood", <ForbiddenMagic:WandCores:7>, [<Thaumcraft:blockMagicalLog:1>,<EnderIO:itemMaterial:5>,<EnderIO:itemMaterial:6>,<Thaumcraft:blockMagicalLog:1>,<EnderIO:itemMaterial:5>,<EnderIO:itemMaterial:6>], "auram 64, praecantatio 48, tempestas 32, instrumentum 24, lux 24", <ForbiddenMagic:WandCores:11>, 7);
mods.thaumcraft.Infusion.addRecipe("ROD_witchwood", <witchery:ingredient:82>, [<gregtech:gt.metaitem.01:8529>,<witchery:witchsapling:0>,<witchery:ingredient:34>,<witchery:witchsapling:1>,<witchery:ingredient:36>,<witchery:witchsapling:2>,<gregtech:gt.metaitem.01:8529>,<witchery:witchsapling:0>,<witchery:ingredient:34>,<witchery:witchsapling:1>,<witchery:ingredient:36>,<witchery:witchsapling:2>], "arbor 64, praecantatio 48, herba 32, instrumentum 24,vacuos 24", <ForbiddenMagic:WandCores:4>, 6);
mods.thaumcraft.Infusion.addRecipe("CAP_manasteel", <Thaumcraft:WandCap:4>, [<gregtech:gt.metaitem.01:2333>,<ProjRed|Core:projectred.core.part:56>,<gregtech:gt.metaitem.01:2333>,<ProjRed|Core:projectred.core.part:56>,<gregtech:gt.metaitem.01:2333>,<ProjRed|Core:projectred.core.part:56>,<gregtech:gt.metaitem.01:2333>,<ProjRed|Core:projectred.core.part:56>,<gregtech:gt.metaitem.01:2333>,<ProjRed|Core:projectred.core.part:56>], "potentia 64, praecantatio 48, electrum 32, instrumentum 24, machina 24", <ForbiddenMagic:WandCaps:3>;, 6);
mods.thaumcraft.Infusion.addRecipe("CAP_terrasteel", <ForbiddenMagic:WandCaps:3>;, [<gregtech:gt.metaitem.02:30501>,<Thaumcraft:blockCrystal:3>,<gregtech:gt.metaitem.01:17339>,<Thaumcraft:blockCrystal:3>,<gregtech:gt.metaitem.02:30501>,<Thaumcraft:blockCrystal:3>,<gregtech:gt.metaitem.01:17339>,<Thaumcraft:blockCrystal:3>], "praecantatio 256, ordo 64, metallum 64, superbia 20, strontio 10", <ForbiddenMagic:WandCaps:2>, 6);
mods.thaumcraft.Infusion.addRecipe("CAP_elementium", <ForbiddenMagic:WandCaps:6>,[<Thaumcraft:blockCrystal:6>,<Thaumcraft:ItemResource:14>,<Thaumcraft:blockCrystal:0>,<Thaumcraft:ItemResource:14>,<Thaumcraft:blockCrystal:1>,<Thaumcraft:ItemResource:14>,<Thaumcraft:blockCrystal:6>,<Thaumcraft:ItemResource:14>,<Thaumcraft:blockCrystal:2>,<Thaumcraft:ItemResource:14>,<Thaumcraft:blockCrystal:3>,<Thaumcraft:ItemResource:14>], "ignis 32, aqua 32 , aer 32, terra 32, ordo 32 , perditio 32, praecantatio 32, potentia 24", <ForbiddenMagic:WandCaps:5>;, 7);
...
mods.thaumcraft.Research.addResearch("CAP_manasteel", "FORBIDDEN", "metallum 5, praecantatio 10, lucrum 3,instrumentum 4, auram 5", 1, 2, 8, <ForbiddenMagic:WandCaps:3>;);
...
mods.thaumcraft.Research.addInfusionPage("CAP_manasteel",<ForbiddenMagic:WandCaps:3>;);
...
mods.thaumcraft.Research.addResearch("CAP_terrasteel", "FORBIDDEN", "terra 5, praecantatio 10, superbia 3,instrumentum 4,strontio 2, vitreus 5", 3, 2, 8, <ForbiddenMagic:WandCaps:2>);
...
mods.thaumcraft.Research.addInfusionPage("CAP_terrasteel",<ForbiddenMagic:WandCaps:2>);
...
mods.thaumcraft.Research.addResearch("CAP_elementium", "FORBIDDEN", "auram 5, praecantatio 10, victus 3,instrumentum 4, humanus 5", 3, 1, 8, <ForbiddenMagic:WandCaps:5>;);
...
mods.thaumcraft.Research.addInfusionPage("CAP_elementium",<ForbiddenMagic:WandCaps:5>;);
...
mods.thaumcraft.Research.addResearch("CAP_vinteum", "FORBIDDEN", "permutatio 5, praecantatio 10,lucrum 3,instrumentum 4, metallum 5", -5, 3, 8, <ForbiddenMagic:WandCaps:1>);
...
mods.thaumcraft.Research.addArcanePage("CAP_vinteum",<ForbiddenMagic:WandCaps:1>);
