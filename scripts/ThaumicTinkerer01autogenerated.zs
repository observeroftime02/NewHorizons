...
mods.thaumcraft.Infusion.addRecipe("SHARETOME", <minecraft:skull:3>,[<minecraft:nether_star>, <minecraft:paper>, <Thaumcraft:ItemInkwell>, <Thaumcraft:ItemThaumonomicon>, <minecraft:paper>],"cognitio 32, praecantatio 16, permutatio 32, pannus 16", <ThaumicTinkerer:shareBook>, 6);
...
mods.thaumcraft.Arcane.addShaped("DARKQUARTZ", <ThaumicTinkerer:darkQuartzItem>, "perditio 8", [[<ore:gemQuartz>, <ore:gemQuartz>, <ore:gemQuartz>],[<ore:gemQuartz>, <ore:coal>, <ore:gemQuartz>],[<ore:gemQuartz>, <ore:gemQuartz>, <ore:gemQuartz>]]);
mods.thaumcraft.Arcane.addShaped("DARKQUARTZ", <ThaumicTinkerer:darkQuartzItem>, "perditio 8", [[<ore:gemQuartz>, <ore:gemQuartz>, <ore:gemQuartz>],[<ore:gemQuartz>, <ore:charcoal>, <ore:gemQuartz>],[<ore:gemQuartz>, <ore:gemQuartz>, <ore:gemQuartz>]]);
...
mods.thaumcraft.Arcane.addShaped("INTERFACE", <ThaumicTinkerer:interface>, "ordo 32, perditio 32, terra 16", [[<Thaumcraft:blockCosmeticSolid:6>, <ore:pipeLargeSteel>, <Thaumcraft:blockCosmeticSolid:6>],[<ore:pipeLargeElectrum>, <gregtech:gt.metaitem.01:32670>, <ore:pipeLargeElectrum>],[<Thaumcraft:blockCosmeticSolid:6>, <ore:pipeLargeSteel>, <Thaumcraft:blockCosmeticSolid:6>]]);
mods.thaumcraft.Arcane.addShaped("INTERFACE", <ThaumicTinkerer:connector>, "ordo 16", [[<Thaumcraft:ItemShard:1>, <ore:screwThaumium>, <Thaumcraft:ItemShard:2>],[null, <Forestry:oakStick>, <ore:screwThaumium>],[<Forestry:oakStick>, null, <Thaumcraft:ItemShard:3>]]);
...
mods.thaumcraft.Arcane.addShaped("DISLOCATOR", <ThaumicTinkerer:dislocator>, "ordo 48, perditio 48, terra 24", [[<ore:screwThaumium>, <Thaumcraft:ItemResource:10>, <ore:plateEnderPearl>],[<ore:circuitBasic>, <ThaumicTinkerer:interface>, <ore:circuitBasic>],[<ore:plateEnderPearl>, <Thaumcraft:ItemResource:10>, <ore:screwThaumium>]]);
...
mods.thaumcraft.Arcane.addShaped("GAS_REMOVER", <ThaumicTinkerer:gasRemover>, "ordo 16, aer 12, motus 8", [[<ore:gemQuartz>, <ore:screwThaumium>, <ore:gemQuartz>],[<ThaumicTinkerer:gaseousLightItem>, <ThaumicTinkerer:interface>, <ThaumicTinkerer:gaseousShadowItem>],[<ThaumicTinkerer:darkQuartzItem>, <ore:screwThaumium>, <ThaumicTinkerer:darkQuartzItem>]]);
...
mods.thaumcraft.Infusion.addRecipe("FIREIGNIS", <Thaumcraft:ItemEssence:1>.withTag({Aspects: [{amount: 8, key: "ignis"}]}),[<minecraft:glowstone_dust>, <Thaumcraft:blockCrystal:1>, <minecraft:redstone>, <Thaumcraft:blockCrystal:1>],"ignis 10, lux 10, aer 10, praecantatio 10", <ThaumicTinkerer:fireFire>, 16);
...
mods.thaumcraft.Infusion.addRecipe("FIREAQUA", <Thaumcraft:ItemEssence:1>.withTag({Aspects: [{amount: 8, key: "aqua"}]}),[<minecraft:glowstone_dust>, <Thaumcraft:blockCrystal:2>, <minecraft:redstone>, <Thaumcraft:blockCrystal:2>],"aqua 10, lux 10, aer 10, praecantatio 10", <ThaumicTinkerer:fireWater>, 16);
...
mods.thaumcraft.Infusion.addRecipe("FIRETERRA", <Thaumcraft:ItemEssence:1>.withTag({Aspects: [{amount: 8, key: "terra"}]}),[<minecraft:glowstone_dust>, <Thaumcraft:blockCrystal:3>, <minecraft:redstone>, <Thaumcraft:blockCrystal:3>],"terra 10, lux 10, aer 10, praecantatio 10", <ThaumicTinkerer:fireEarth>, 16);
...
mods.thaumcraft.Infusion.addRecipe("FIREORDO", <Thaumcraft:ItemEssence:1>.withTag({Aspects: [{amount: 8, key: "ordo"}]}),[<minecraft:glowstone_dust>, <Thaumcraft:blockCrystal:4>, <minecraft:redstone>, <Thaumcraft:blockCrystal:4>],"ordo 10, lux 10, aer 10, praecantatio 10", <ThaumicTinkerer:fireOrder>, 16);
...
mods.thaumcraft.Infusion.addRecipe("FIREAER", <Thaumcraft:ItemEssence:1>.withTag({Aspects: [{amount: 8, key: "aer"}]}),[<minecraft:glowstone_dust>, <Thaumcraft:blockCrystal>, <minecraft:redstone>, <Thaumcraft:blockCrystal>],"aer 10, lux 10, motus 10, praecantatio 10", <ThaumicTinkerer:fireAir>, 16);
...
mods.thaumcraft.Infusion.addRecipe("FIREPERDITIO", <Thaumcraft:ItemEssence:1>.withTag({Aspects: [{amount: 8, key: "perditio"}]}),[<minecraft:glowstone_dust>, <Thaumcraft:blockCrystal>, <minecraft:redstone>, <Thaumcraft:blockCrystal>],"perditio 10, lux 10, aer 10, praecantatio 10", <ThaumicTinkerer:fireChaos>, 16);
...
mods.thaumcraft.Infusion.addRecipe("INFUSEDSEED", <minecraft:wheat_seeds>,[<Thaumcraft:blockCrystal>, <Thaumcraft:blockCrystal>, <Thaumcraft:blockCrystal>, <Thaumcraft:blockCrystal>],"messis 32, meto 32, aer 16", <ThaumicTinkerer:infusedSeeds>.withTag({mainAspect: {Aspects: [{amount: 1, key: "aer"}]}, aspectTendencies: {Aspects: []}}), 4);
...
mods.thaumcraft.Infusion.addRecipe("INFUSEDSEED", <minecraft:wheat_seeds>,[<Thaumcraft:blockCrystal:1>, <Thaumcraft:blockCrystal:1>, <Thaumcraft:blockCrystal:1>, <Thaumcraft:blockCrystal:1>],"messis 32, meto 32, ignis 16", <ThaumicTinkerer:infusedSeeds>.withTag({mainAspect: {Aspects: [{amount: 1, key: "ignis"}]}, aspectTendencies: {Aspects: []}}), 4);
mods.thaumcraft.Infusion.addRecipe("INFUSEDSEED", <minecraft:wheat_seeds>,[<Thaumcraft:blockCrystal:2>, <Thaumcraft:blockCrystal:2>, <Thaumcraft:blockCrystal:2>, <Thaumcraft:blockCrystal:2>],"messis 32, meto 32, aqua 16", <ThaumicTinkerer:infusedSeeds>.withTag({mainAspect: {Aspects: [{amount: 1, key: "aqua"}]}, aspectTendencies: {Aspects: []}}), 4);
mods.thaumcraft.Infusion.addRecipe("INFUSEDSEED", <minecraft:wheat_seeds>,[<Thaumcraft:blockCrystal:3>, <Thaumcraft:blockCrystal:3>, <Thaumcraft:blockCrystal:3>, <Thaumcraft:blockCrystal:3>],"messis 32, meto 32, terra 16", <ThaumicTinkerer:infusedSeeds>.withTag({mainAspect: {Aspects: [{amount: 1, key: "terra"}]}, aspectTendencies: {Aspects: []}}), 4);
mods.thaumcraft.Infusion.addRecipe("INFUSEDSEED", <minecraft:wheat_seeds>,[<Thaumcraft:blockCrystal:4>, <Thaumcraft:blockCrystal:4>, <Thaumcraft:blockCrystal:4>, <Thaumcraft:blockCrystal:4>],"messis 32, meto 32, ordo 16", <ThaumicTinkerer:infusedSeeds>.withTag({mainAspect: {Aspects: [{amount: 1, key: "ordo"}]}, aspectTendencies: {Aspects: []}}), 4);
mods.thaumcraft.Infusion.addRecipe("INFUSEDSEED", <minecraft:wheat_seeds>,[<Thaumcraft:blockCrystal:5>, <Thaumcraft:blockCrystal:5>, <Thaumcraft:blockCrystal:5>, <Thaumcraft:blockCrystal:5>],"messis 32, meto 32, perditio 16", <ThaumicTinkerer:infusedSeeds>.withTag({mainAspect: {Aspects: [{amount: 1, key: "perditio"}]}, aspectTendencies: {Aspects: []}}), 4);
...
mods.thaumcraft.Arcane.addShaped("FUNNEL", <ThaumicTinkerer:funnel>, "ordo 8, perditio 8, aqua 8", [[<ore:screwThaumium>, <ore:craftingToolScrewdriver>, <ore:screwThaumium>],[<ore:plateThaumium>, <ore:pipeMediumStainlessSteel>, <ore:plateThaumium>]]);
...
mods.thaumcraft.Infusion.addRecipe("REPAIRER", <Thaumcraft:blockCosmeticSolid:4>,[<gregtech:gt.metaitem.01:17330>, <gregtech:gt.metaitem.01:17032>, <dreamcraft:item.ReinforcedGlassPlate>, <harvestcraft:hardenedleatherItem>, <Thaumcraft:ItemResource:7>, <gregtech:gt.metaitem.01:17500>, <dreamcraft:item.ReinforcedGlassPlate>, <gregtech:gt.metaitem.01:17086>],"fabrico 32, instrumentum 32, ordo 16, praecantatio 16, potentia 8", <ThaumicTinkerer:repairer>, 8);
...
mods.thaumcraft.Arcane.addShaped("MAGNETS", <ThaumicTinkerer:magnet>, "aer 30, terra 25, ordo 20, perditio 15", [[<ore:screwThaumium>, <ore:plateSteelMagnetic>, <ore:screwThaumium>],[<Thaumcraft:blockCrystal:3>, <ore:plateThaumium>, <Thaumcraft:blockCrystal>],[<Thaumcraft:blockMagicalLog>, <ThaumicTinkerer:focusTelekinesis>, <Thaumcraft:blockMagicalLog>]]);
...
mods.thaumcraft.Arcane.addShaped("MAGNETS", <ThaumicTinkerer:magnet:1>, "aer 25, terra 30, ordo 15, perditio 20", [[<ore:screwThaumium>, <ore:plateThaumium>, <ore:screwThaumium>],[<Thaumcraft:blockCrystal:3>, <ore:plateSteelMagnetic>, <Thaumcraft:blockCrystal>],[<Thaumcraft:blockMagicalLog:1>, <ThaumicTinkerer:focusTelekinesis>, <Thaumcraft:blockMagicalLog:1>]]);
...
mods.thaumcraft.Arcane.addShaped("ANIMATION_TABLET", <ThaumicTinkerer:animationTablet>, "aer 35, ignis 30, ordo 20", [[<ore:plateRoseGold>, <ore:plateThaumium>, <ore:plateRoseGold>],[<ore:plateElectrum>, <ore:plateThaumium>, <ore:plateElectrum>],[<ore:screwThaumium>, <Thaumcraft:ItemGolemCore:100>, <ore:screwThaumium>]]);
...
mods.thaumcraft.Infusion.addRecipe("LEVITATOR_LOCOMOTIVE", <Thaumcraft:blockLifter>,[<gregtech:gt.metaitem.01:17804>, <gregtech:gt.metaitem.01:27032>, <EMT:EMTItems:7>, <gregtech:gt.metaitem.01:27032>, <gregtech:gt.metaitem.01:17804>, <gregtech:gt.metaitem.01:27032>, <EMT:EMTItems:7>, <gregtech:gt.metaitem.01:27032>],"motus 30, ordo 20, praecantatio 15, aer 25, potentia 10", <ThaumicTinkerer:Levitational Locomotive>, 4);
...
mods.thaumcraft.Arcane.addShaped("LEVITATOR_LOCOMOTIVE", <ThaumicTinkerer:Levitational Locomotive Relay>, "aer 30, terra 20, ordo 10", [[<ore:paneGlassColorless>, <ore:lensInfusedWater>, <ore:paneGlassColorless>],[<ore:lensInfusedWater>, <Thaumcraft:blockMagicalLog>, <ore:lensInfusedWater>],[<ore:paneGlassColorless>, <ore:lensInfusedWater>, <ore:paneGlassColorless>]]);
...
mods.thaumcraft.Research.setConcealed("INFUSEDPOTIONS", true);
mods.thaumcraft.Infusion.addRecipe("CLEANSING_TALISMAN", <minecraft:ender_eye>,[<ThaumicTinkerer:darkQuartzItem>, <Thaumcraft:ItemResource:1>, <ThaumicTinkerer:darkQuartzItem>, <minecraft:ghast_tear>, <ThaumicTinkerer:darkQuartzItem>, <minecraft:ghast_tear>, <ThaumicTinkerer:darkQuartzItem>, <Thaumcraft:ItemResource:1>],"humanus 32, instrumentum 24, sano 16, victus 16", <ThaumicTinkerer:cleansingTalisman>, 4);
...
mods.thaumcraft.Research.setConcealed("INFUSEDPOTIONS", true);
mods.thaumcraft.Arcane.addShaped("PLATFORM", <ThaumicTinkerer:platform> * 2, "aer 10, perditio 10", [[<ore:screwThaumium>, <ore:craftingToolScrewdriver>, <ore:screwThaumium>],[<Thaumcraft:blockWoodenDevice:6>, <Thaumcraft:blockWoodenDevice:7>, <Thaumcraft:blockWoodenDevice:6>]]);
...
mods.thaumcraft.Infusion.addRecipe("BLOOD_SWORD", <Thaumcraft:ItemSwordThaumium>,[<gregtech:gt.metaitem.02:29500>, <minecraft:ghast_tear>, <minecraft:rotten_flesh>, <minecraft:porkchop>, <minecraft:fish>, <minecraft:nether_wart>, <gregtech:gt.metaitem.02:29500>, <minecraft:bone>, <minecraft:beef>, <minecraft:blaze_powder>, <minecraft:spider_eye>, <minecraft:chicken>],"fames 32, humanus 8, spiritus 16, tenebrae 24, telum 16", <ThaumicTinkerer:bloodSword>, 8);
...
mods.thaumcraft.Arcane.addShaped("SUMMON", <ThaumicTinkerer:spawner>, "ordo 75, perditio 75, terra 50", [[<ore:gemFlawlessRuby>, <Thaumcraft:blockMetalDevice:5>, <ore:gemFlawlessRuby>],[<Thaumcraft:blockCosmeticSolid>, <ore:plateDenseObsidian>, <Thaumcraft:blockCosmeticSolid>],[<ore:screwThaumium>, <ore:craftingToolScrewdriver>, <ore:screwThaumium>]]);
...
mods.thaumcraft.Arcane.addShaped("FOCUS_SMELT", <ThaumicTinkerer:focusSmelt>, "ignis 16, perditio 12, ordo 12, aer 8", [[<Thaumcraft:ItemResource:14>, <Thaumcraft:FocusExcavation>, <Thaumcraft:ItemResource:14>],[<Thaumcraft:ItemResource:1>, <minecraft:furnace>, <Thaumcraft:ItemResource:1>],[<Thaumcraft:ItemResource:14>, <Thaumcraft:FocusFire>, <Thaumcraft:ItemResource:14>]]);
...
mods.thaumcraft.Infusion.addRecipe("FOCUS_FLIGHT", <Thaumcraft:ItemSwordElemental>,[<gregtech:gt.metaitem.02:21330>, <EMT:EMTItems:7>, <gregtech:gt.metaitem.01:2532>, <gregtech:gt.metaitem.02:21330>, <EMT:EMTItems:7>, <gregtech:gt.metaitem.01:2532>],"aer 32, iter 24, motus 32, volatus 24, aer 16", <ThaumicTinkerer:focusFlight>, 6);
...
mods.thaumcraft.Infusion.addRecipe("FOCUS_DEFLECT", <ThaumicTinkerer:focusFlight>,[<Thaumcraft:ItemResource:10>, <Thaumcraft:blockCosmeticSolid:3>, <Thaumcraft:blockCrystal:4>, <Thaumcraft:ItemResource:10>, <Thaumcraft:blockCosmeticSolid:3>, <Thaumcraft:blockCrystal:4>],"aer 32, ordo 24, tutamen 32, auram 24, alienis 16", <ThaumicTinkerer:focusDeflect>, 6);
...
mods.thaumcraft.Arcane.addShaped("FOCUS_ENDER_CHEST", <ThaumicTinkerer:focusEnderChest>, "perditio 50, ordo 50", [[<Thaumcraft:ItemResource:14>, <Thaumcraft:blockMirror>, <Thaumcraft:ItemResource:14>],[<ore:plateEnderium>, <Thaumcraft:FocusPortableHole>, <ore:plateEnderium>],[<Thaumcraft:ItemResource:14>, <ore:plateNetherStar>, <Thaumcraft:ItemResource:14>]]);
...
mods.thaumcraft.Warp.addToResearch("ANIMATION_TABLET", 3);
mods.thaumcraft.Infusion.addRecipe("FOCUS_TELEKINESIS", <ThaumicTinkerer:focusFlight>,[<Thaumcraft:blockCrystal>, <gregtech:gt.metaitem.01:17522>, <gregtech:gt.metaitem.01:17355>, <gregtech:gt.metaitem.01:17522>, <Thaumcraft:blockCrystal>, <gregtech:gt.metaitem.01:17522>, <gregtech:gt.metaitem.01:17355>, <gregtech:gt.metaitem.01:17522>],"aer 24, cognitio 32, motus 32, perditio 24, lucrum 16", <ThaumicTinkerer:focusTelekinesis>, 10);
...
mods.thaumcraft.Infusion.addRecipe("FOCUS_DISLOCATION", <Thaumcraft:FocusTrade>,[<gregtech:gt.metaitem.02:29500>, <gregtech:gt.metaitem.01:17522>, <gregtech:gt.metaitem.02:29514>, <gregtech:gt.metaitem.01:17522>, <gregtech:gt.metaitem.02:29500>, <gregtech:gt.metaitem.01:17522>, <gregtech:gt.metaitem.02:29514>, <gregtech:gt.metaitem.01:17522>],"alienis 64, praecantatio 32, tenebrae 32, vacuos 32, vitium 16, permutatio 16 ", <ThaumicTinkerer:focusDislocation>, 10);
...
mods.thaumcraft.Infusion.addRecipe("FOCUS_HEAL", <Thaumcraft:FocusPech>,[<minecraft:golden_apple>, <Thaumcraft:ItemResource:14>, <gregtech:gt.metaitem.01:17351>, <Thaumcraft:ItemResource:14>, <minecraft:golden_carrot>, <Thaumcraft:ItemResource:14>, <gregtech:gt.metaitem.01:17351>, <Thaumcraft:ItemResource:14>],"sano 24, spiritus 32, praecantatio 32, victus 24", <ThaumicTinkerer:focusHeal>, 10);
...
mods.thaumcraft.Infusion.addRecipe("XP_TALISMAN", <Thaumcraft:ItemBaubleBlanks>,[<Thaumcraft:ItemZombieBrain>, <gregtech:gt.metaitem.01:17522>, <Thaumcraft:ItemZombieBrain>, <gregtech:gt.metaitem.01:17086>, <Thaumcraft:ItemZombieBrain>, <gregtech:gt.metaitem.01:17522>, <Thaumcraft:ItemZombieBrain>, <gregtech:gt.metaitem.01:17500>],"bestia 24, lucrum 32, machina 16, permutatio 16, humanus 8", <ThaumicTinkerer:xpTalisman>, 8);
...
mods.thaumcraft.Arcane.addShaped("REVEALING_HELM", <ThaumicTinkerer:revealingHelm>, "aer 35, aqua 35, terra 35, ignis 35, ordo 35, perditio 35", [[<ore:screwThaumium>, <ore:craftingToolScrewdriver>, <ore:screwThaumium>],[<ore:plateThaumium>, <Thaumcraft:ItemGoggles>, <ore:plateThaumium>],[null, <Thaumcraft:ItemHelmetThaumium>, null]]);
