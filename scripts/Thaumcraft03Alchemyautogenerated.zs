...
mods.thaumcraft.Arcane.addShaped("TALLOW", <Thaumcraft:blockCandle>, "ignis 3, ordo 1, perditio 1, aer 3", [[null, <minecraft:string>, null],[null, <Thaumcraft:ItemResource:4>, null],[null, <Thaumcraft:ItemResource:4>, null]]);
...
mods.thaumcraft.Arcane.addShaped("DISTILESSENTIA", <Thaumcraft:blockStoneDevice>, "ignis 15, aer 10, ordo 5", [[<Thaumcraft:blockCosmeticSolid:7>, <Railcraft:machine.beta:3>, <Thaumcraft:blockCosmeticSolid:7>],[<ore:plateThaumium>, <ore:craftingIronFurnace>, <ore:plateThaumium>],[<Thaumcraft:blockCosmeticSolid:7>, <Thaumcraft:blockMetalDevice>, <Thaumcraft:blockCosmeticSolid:7>]]);
...
mods.thaumcraft.Arcane.addShaped("DISTILESSENTIA", <Thaumcraft:ItemResource:8> * 3, "ordo 10, aqua 5", [[<ore:springSmallGold>, <ore:plateGold>, <ore:springSmallGold>],[<Thaumcraft:blockWoodenDevice:7>, <Thaumcraft:blockWoodenDevice:7>, <Thaumcraft:blockWoodenDevice:7>],[<ore:springSmallGold>, <ore:plateGold>, <ore:springSmallGold>]]);
mods.thaumcraft.Arcane.addShaped("DISTILESSENTIA", <Thaumcraft:blockMetalDevice:1>, "aer 5, aqua 10, ignis 5", [[<ore:plateThaumium>, <ore:pipeMediumSteel>, <ore:plateThaumium>],[<Thaumcraft:ItemResource:8>, <Railcraft:machine.beta:3>, <Thaumcraft:ItemResource:8>],[<ore:plateThaumium>, <ore:pipeMediumSteel>, <ore:plateThaumium>]]);
mods.thaumcraft.Arcane.addShaped("DISTILESSENTIA", <Thaumcraft:blockMetalDevice:9>, "ordo 10, aqua 5, ignis 5", [[<Thaumcraft:blockTube>, <Thaumcraft:ItemResource:8>, <Thaumcraft:blockTube>],[<Thaumcraft:blockTube:1>, <ore:blockThaumium>, <Thaumcraft:blockTube:1>],[<Thaumcraft:blockTube>, <Thaumcraft:ItemResource:8>, <Thaumcraft:blockTube>]]);
mods.thaumcraft.Arcane.addShaped("TUBES", <Thaumcraft:blockTube> * 4, "ordo 8, aqua 8", [[<ore:screwThaumium>, <ore:nuggetGold>, <ore:screwThaumium>],[<Thaumcraft:ItemNugget:5>, <ore:pipeSmallSteel>, <Thaumcraft:ItemNugget:5>],[<ore:screwThaumium>, <ore:nuggetGold>, <ore:screwThaumium>]]);
...
mods.thaumcraft.Arcane.addShaped("TUBES", <Thaumcraft:blockTube:1>, "ordo 8, aqua 8", [[<ore:screwThaumium>, <minecraft:lever>, <ore:screwThaumium>],[<ore:plateAnyRubber>, <Thaumcraft:blockTube>, <ore:gearGtSmallThaumium>],[null, null, null]]);
mods.thaumcraft.Arcane.addShaped("TUBES", <Thaumcraft:ItemResonator>, "aer 8, aqua 8", [[<ore:craftingToolScrewdriver>, <ore:stickThaumium>, null],[<ore:screwThaumium>, <Thaumcraft:ItemNugget:5>, <ore:stickThaumium>],[<ore:stickWood>, <ore:screwThaumium>, <ore:craftingToolFile>]]);
mods.thaumcraft.Arcane.addShaped("TUBEFILTER", <Thaumcraft:blockTube:3>, "ordo 16, aqua 16", [[<ore:craftingToolScrewdriver>, <Thaumcraft:ItemResource:8>, <ore:craftingToolFile>],[<ore:screwThaumium>, <Thaumcraft:blockTube>, <ore:screwThaumium>],[null, <Thaumcraft:ItemResource:8>, null]]);
...
mods.thaumcraft.Arcane.addShaped("TUBEFILTER", <Thaumcraft:blockTube:5>, "terra 16, aqua 16", [[null, null, null],[<ore:ringAnyRubber>, <Thaumcraft:blockTube>, <ore:ringAnyRubber>],[null, null, null]]);
mods.thaumcraft.Arcane.addShaped("TUBEFILTER", <Thaumcraft:blockTube:6>, "ordo 16, perditio 8, aqua 8", [[null, null, null],[<ore:dyeBlue>, <Thaumcraft:blockTube>, <ore:screwThaumium>],[null, null, null]]);
mods.thaumcraft.Arcane.addShaped("CENTRIFUGE", <Thaumcraft:blockTube:2>, "ordo 32, perditio 16, aqua 16", [[<ore:screwThaumium>, <Thaumcraft:blockTube>, <ore:screwThaumium>],[<Thaumcraft:blockMetalDevice:1>, <Thaumcraft:blockMetalDevice:9>, <gregtech:gt.metaitem.01:32641>],[<ore:screwThaumium>, <Thaumcraft:blockTube>, <ore:screwThaumium>]]);
...
mods.thaumcraft.Arcane.addShaped("CENTRIFUGE", <Thaumcraft:blockTube:4> * 4, "ordo 20, aqua 20", [[<Thaumcraft:ItemEssence>, <Thaumcraft:blockTube:1>, <Thaumcraft:ItemEssence>],[<Thaumcraft:blockTube>, <ore:screwThaumium>, <Thaumcraft:blockTube>],[<Thaumcraft:ItemEssence>, <Thaumcraft:blockTube:5>, <Thaumcraft:ItemEssence>]]);
mods.thaumcraft.Arcane.addShaped("ESSENTIACRYSTAL", <Thaumcraft:blockTube:7>, "terra 20, ordo 15, aqua 10", [[<ore:plateThaumium>, <minecraft:dispenser>, <ore:plateThaumium>],[<Thaumcraft:blockCrystal:6>, <Thaumcraft:blockMetalDevice:9>, <Thaumcraft:blockCrystal:6>],[<ore:screwThaumium>, <Thaumcraft:blockTube>, <ore:screwThaumium>]]);
...
mods.thaumcraft.Arcane.addShaped("THAUMATORIUM", <Thaumcraft:blockMetalDevice:12>, "ignis 10, ordo 10, aqua 10", [[<ore:plateThaumium>, <ore:gemFlawlessAmber>, <ore:plateThaumium>],[<ore:gemFlawlessAmber>, <Thaumcraft:ItemZombieBrain>, <ore:gemFlawlessAmber>],[<ore:plateThaumium>, <ore:gemFlawlessAmber>, <ore:plateThaumium>]]);
...
mods.thaumcraft.Arcane.addShaped("JARLABEL", <Thaumcraft:blockJar>, "aqua 2", [[<ore:paneGlassColorless>, <ore:plateAnyRubber>, <ore:paneGlassColorless>],[<ore:paneGlassColorless>, null, <ore:paneGlassColorless>],[<ore:paneGlassColorless>, <ore:paneGlassColorless>, <ore:paneGlassColorless>]]);
mods.thaumcraft.Research.clearPages("JARVOID");
mods.thaumcraft.Research.addPage("JARVOID", "tc.research_page.JARVOID.1");
mods.thaumcraft.Infusion.addRecipe("JARVOID", <Thaumcraft:blockJar>,[<gregtech:gt.metaitem.01:17804>, <minecraft:blaze_powder>, <gregtech:gt.metaitem.01:17533>, <Thaumcraft:ItemNugget:5>],"vacuos 7, praecantatio 7, perditio 7, aqua 7", <Thaumcraft:blockJar:3>, 2);
...
mods.thaumcraft.Infusion.addRecipe("ARCANESPA", <Thaumcraft:blockJar>,[<dreamcraft:item.StainlessSteelBars>, <minecraft:quartz_block>, <Thaumcraft:blockCosmeticSolid:6>, <Thaumcraft:blockCosmeticSolid:7>, <Thaumcraft:ItemBathSalts>, <Thaumcraft:blockCosmeticSolid:7>, <Thaumcraft:blockCosmeticSolid:6>, <minecraft:quartz_block>],"ordo 24, praecantatio 16, sano 16, aqua 32, machina 8", <Thaumcraft:blockStoneDevice:12>, 4);
